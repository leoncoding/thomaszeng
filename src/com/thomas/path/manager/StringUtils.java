package com.thomas.path.manager;
...
public class StringUtils {
	...
	public static void setTextTypeface(FontType type, Context context,
		...
		switch (type) {
		case ROBOTO_LIGHT:
			setTextFont(context, textView, "font/Roboto-Light.ttf");
			break;
		case ROBOTO_THIN:
			setTextFont(context, textView, "font/Roboto-Thin.ttf");
			break;
		case WENDY:
			setTextFont(context, textView, "font/Wendy.ttf");
			break;
		case XIYUAN:
			setTextFont(context, textView, "font/xiyuan.ttf");
			break;
	...
	public static void setButtonTypeface(FontType type, Context context,
		...
		switch (type) {
		case ROBOTO_LIGHT:
			setButtonFont(context, btnView, "font/Roboto-Light.ttf");
			break;
		case ROBOTO_THIN:
			setButtonFont(context, btnView, "font/Roboto-Thin.ttf");
			break;
		case WENDY:
			setButtonFont(context, btnView, "font/Wendy.ttf");
			break;
		case XIYUAN:
			setButtonFont(context, btnView, "font/xiyuan.ttf");
			break;
	...
	public static void setEditTextTypeface(FontType type, Context context,
		...
		switch (type) {
		case ROBOTO_LIGHT:
			setEditTextFont(context, edtView, "font/Roboto-Light.ttf");
			break;
		case ROBOTO_THIN:
			setEditTextFont(context, edtView, "font/Roboto-Thin.ttf");
			break;
		case WENDY:
			setEditTextFont(context, edtView, "font/Wendy.ttf");
			break;
		case XIYUAN:
			setEditTextFont(context, edtView, "font/xiyuan.ttf");
			break;
	...
	public static void setCheckBoxTypeface(FontType type, Context context,
		...
		switch (type) {
		case ROBOTO_LIGHT:
			setCheckBoxFont(context, edtView, "font/Roboto-Light.ttf");
			break;
		case ROBOTO_THIN:
			setCheckBoxFont(context, edtView, "font/Roboto-Thin.ttf");
			break;
		case WENDY:
			setCheckBoxFont(context, edtView, "font/Wendy.ttf");
			break;
		case XIYUAN:
			setCheckBoxFont(context, edtView, "font/xiyuan.ttf");
			break;
